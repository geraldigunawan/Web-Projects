...
<div id="content">
<h2>Clu&Clo &raquo; Edit menu</h2>
<div id="edit_menu" class="edit_menu">
	<form name="edit_menu_form" id="edit_menu_form" method="post" enctype="multipart/form-data" action="<?php echo site_url('admin/changemenu/do_edit/'.$editlist['id'].'/')?>">
    	<dl>
...
<?php if($editlist['picture']!=""){ ?> <dt><img src="<?php echo base_url()?>userdata/appetizer/<?php echo $editlist['picture']?>" height="100" width="200"></dt><?php }?>
            <dt> <input type="file" name="editmenu" id="editmenu">          	
